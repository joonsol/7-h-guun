...
public class PostService {
    ...
    public PostResponse findById(Long id, HttpSession session) {
        ...
        Long memmberId = (Long) session.getAttribute(LOGIN_MEMBER_ID);
        ...
        if(!post.getMember() .getId().equals(memmberId)) {
            throw new IllegalArgumentException("본잉이 작성한 글만 조회할 수 있습니다.");
        }
